      ...
      <div className="container mx-auto px-4 max-w-3xl space-y-16">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-lg leading-relaxed">
            Sun Ra preached spiritual liberation through music. John Coltrane dedicated his life to making healing music. Albert Ayler believed that music was the healing force of the universe. Pharoah Sanders assured us that the creator had a master plan. Alice Coltrane started a monastery to share the message. Fela Kuti told us music was a weapon. Music is a powerful force that has the power to heal, unite and liberate. My work is an homage to these ancestors and an attempt to bring new listeners to creative, improvised music for the purpose of collective liberation.
          </p>
        </div>
